...
interface IMaxiChanceRepository {
    fun getPromotionalForSuperChanceRoom(): Observable<PromotionalEntityRoom>?
    fun payMaxichance(chanceNumbers: List<ChanceDTO>, lotteries: List<LotteryDTO>, value: Double, isRetry: Boolean = true,
